...
* **Overlapping polarization: On the contextual determinants of the interplay between ideological and affective polarization** (with Pedro Riera). [*Electoral Studies*, 2023](https://doi.org/10.1016/j.electstud.2023.102628). <br/><a href="./pubs/ee2023.pdf" target="_blank"><button type="button button1">PDF</button></a> <a href=""><button type="button button1">details</button></a>
